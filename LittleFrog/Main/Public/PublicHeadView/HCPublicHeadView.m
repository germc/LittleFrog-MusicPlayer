...
- (void)setUpHeadView
{
    ...
    self.listenumLabel  = [HCCreatTool labelWithView:self];

    self.listenumLabel.font = HCMiddleFont;
}
- (void)setUpButtons
{
    self.collectButton  = [HCCreatTool buttonWithView:self image:[[UIImage imageNamed:@"icon_ios_add"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] state:UIControlStateNormal];
    [self.collectButton addTarget:self action:@selector(clickCollectButton) forControlEvents:UIControlEventTouchUpInside];
    
    self.shareButton    = [HCCreatTool buttonWithView:self image:[[UIImage imageNamed:@"icon_ios_export"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate ] state:UIControlStateNormal];
    [self.shareButton addTarget:self action:@selector(clickShareButton) forControlEvents:UIControlEventTouchUpInside];
    
    self.likeButton     = [HCCreatTool buttonWithView:self image:[[UIImage imageNamed:@"icon_ios_heart"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] state:UIControlStateNormal];
    ...
    self.MenuButton = [HCCreatTool buttonWithView:self image:[[UIImage imageNamed:@"icon_ios_list"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] state:UIControlStateNormal] ;
